 ...
 * @return {mixed}      whatever the above function returned
 */
 ...
 * @param  {mixed}    args... Variadic arguments to call the function with
 * @return {Promise}
 */
exports.callAsync = function callAsync(fnc) {
  var ctrl = new PromiseCtrl("Call Async: '" + fnc.name + "'");
...
function complete (promise, how, with_data) {
  // had to change the following as it would cause problems
