...
Procedure.prototype.liftSeries = function () {
  ...
  if (this.defaultParams instanceof Array) {
    return fns.map(_curryFn.bind(null, this.defaultParams));
  }
  return fns;
};

/**
 * create a single predicate which returns true of all the
